...
const About = () => {
    return (
        <section
            className="section-about sec-wrapper overflow-x-hidden"
            id="about"
        >
                    ...
                    <div className="lg:w-[60%] w-full mt-4">
                        <div className="md:pl-[60px]">
                            ...
                            <div className="mt-10 about-description">
                                ...
                                <p>
                                    My work experience as a company and
                                    freelance developer helped me to gain
                                    proficient understanding of various tools
                                    used in creating web applications.
                                </p>
                                <p>
                                    I make sure to collaborate with the entire
                                    team involved in the development process.
                                </p>
